...
import 'lebs_escalation_form_controller.dart';

class LebsEscalationFormWidget extends StatelessWidget {
  final String? signalId;

  const LebsEscalationFormWidget({Key? key, this.signalId}) : super(key: key);

  @override
  Widget build(BuildContext context) => GetX<LebsEscalationFormController>(
        init: LebsEscalationFormController(signalId: signalId),
        builder: (controller) => WillPopScope(
          ...
          child: Scaffold(
            appBar: AppBar(
              title: const Text('HEBS Escalation Form'),
