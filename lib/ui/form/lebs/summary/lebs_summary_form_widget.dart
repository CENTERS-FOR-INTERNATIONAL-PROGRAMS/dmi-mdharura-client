...
import 'lebs_summary_form_controller.dart';

class LebsSummaryFormWidget extends StatelessWidget {
  final String? signalId;

  const LebsSummaryFormWidget({
    Key? key,
    this.signalId,
  }) : super(key: key);

  @override
  Widget build(BuildContext context) => GetX<LebsSummaryFormController>(
        init: LebsSummaryFormController(signalId: signalId),
